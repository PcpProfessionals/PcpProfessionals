...
{
    public partial class RaidBatteryAddInventory : Form
    {
        private string _componentLabelText;

        public RaidBatteryAddInventory(string componentNameLabel)
        {
            InitializeComponent();
        ...
        private void RaidBatteryAddInventory_Load(object sender, EventArgs e)
        {
